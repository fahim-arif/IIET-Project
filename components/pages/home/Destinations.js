                           ...
                           <OwlCarousel className="row owl-carousel destinations-1"  {...destinationsOptions}>
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Paris Hill hrefur</Link>
                                       </h3>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Lake Garda, Spain</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Mount Dtna, Spain</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Amalfi Costa, Italy</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                           ...
                           <OwlCarousel className="row owl-carousel destinations-2"  {...destinationsOptions}>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Fench Rivira, Italy</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Mount Dtna, Italyr</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                           ...
                           <OwlCarousel className="row owl-carousel destinations-1"  {...destinationsOptions}>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Maritime Heritage</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Souks of Deira</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3>
                                           ...
                                           <Link href={`${process.env.PUBLIC_URL}/package-details`}>Jumeirah Mosque</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
