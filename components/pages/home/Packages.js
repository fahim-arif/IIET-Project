                 ...
                 <div className="package-card">
                   ...
                   <div className="package-details">
                     ...
                     <h3>
                       ...
                       <Link href={`${process.env.PUBLIC_URL}/package-details`}>Paris Hill Tour</Link>
                     </h3>
               ...
               <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="300ms">
                 <div className="package-card">
                   ...
                   <div className="package-details">
                     ...
                     <h3>
                       <i className="flaticon-arrival" />
                       <Link href={`${process.env.PUBLIC_URL}/package-details`}>Lake Garda, Italy</Link>
                     </h3>
                     <div className="package-rating">
                       <strong><i className="bx bxs-star" /><span>8K+</span> Rating</strong>
                     </div>
               ...
               <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="300ms">
                 <div className="package-card">
                   ...
                   <div className="package-details">
                     ...
                     <h3>
                       <i className="flaticon-arrival" />
                       <Link href={`${process.env.PUBLIC_URL}/package-details`}>French Rivira, France</Link>
                     </h3>
                     <div className="package-rating">
                       <strong><i className="bx bxs-star" /><span>8K+</span> Rating</strong>
                     </div>
               ...
               <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="600ms">
                 <div className="package-card">
                   ...
                   <div className="package-details">
                     ...
                     <h3>
                       <i className="flaticon-arrival" />
                       <Link href={`${process.env.PUBLIC_URL}/package-details`}>Lake Geneva, France</Link>
                     </h3>
                     <div className="package-rating">
                       <strong><i className="bx bxs-star" /><span>8K+</span> Rating</strong>
                     </div>
